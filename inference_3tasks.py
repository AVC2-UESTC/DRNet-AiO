...
from utils.data_util import crop_HWC_img, ImageSpliterTh
...
if __name__ == '__main__':
    ...
    candidates = ['denoise', 'dehaze', 'derain']
    base_prompts = {}
    ...
    if opt.task == 'denoise':
        ...
        net_denoise.eval()
        test_Denoise(net_denoise, testset, task="CBSD68", sigma=50, prompt=base_prompts[opt.task])
    else:
        # derain 
        net_derain = DRNet(num_experts=4, input_size=128, expert_dim=3, num_blocks=[4,6,6,8])
